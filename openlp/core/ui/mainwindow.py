...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, main_window):
        ...
        """
        main_window.setWindowTitle(UiStrings().OLPV2x + ' - WCAC Edition')
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow, RegistryProperties):
    ...
    def on_help_web_site_clicked(self):
        ...
        """
        import webbrowser
        webbrowser.open_new('https://github.com/BlazingAsher/OpenLP-WCAC')
    ...
    def on_online_help_clicked(self):
        ...
        """
        import webbrowser
        webbrowser.open_new('https://github.com/BlazingAsher/OpenLP-WCAC/wiki')
