...
class SongsTab(SettingsTab):
    ...
    def setupUi(self):
        ...
        self.display_author_check_box = QtWidgets.QCheckBox(self.mode_group_box)
        self.display_author_check_box.setObjectName('author_check_box')

        self.mode_layout.addWidget(self.display_copyright_check_box)
        self.mode_layout.addWidget(self.display_author_check_box)
        ...
        self.display_author_check_box.stateChanged.connect(self.on_display_author_check_box_changed)
    ...
    def retranslateUi(self):
        ...
        self.display_author_check_box.setText('Show song author')
    ...
    def on_display_author_check_box_changed(self, check_state):
        self.display_author = (check_state == QtCore.Qt.Checked)
    ...
    def load(self):
        ...
        self.display_author = settings.value('show song author')
        ...
        self.display_author_check_box.setChecked(self.display_author)
        settings.endGroup()
